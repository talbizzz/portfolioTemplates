...
export default () => {
    ...
    return(
        <div style={{margin:size===0?"1%":"5%"}}>
            <a className="link gray hover-silver dib h2 w2" href="https://facebook.com" title="Facebook">
            ...
            <a className="link hover-silver gray dib h2 w2 ml3" href="https://instagram.com/mrmrs_" title="Instagram">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd"
                     clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                    <path
            ...
            <a className="link hover-silver gray dib h2 w2 ml3" href="https://youtube.com" title="youtube">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd"
                     clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                    <path
            ...
            <a className="link hover-silver gray dib h2 w2 ml3" href="https://linkedin.com" title="LinkedIn">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd"
                     clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                    <path
